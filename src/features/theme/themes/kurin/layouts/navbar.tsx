...
export function Navbar({
  ...
  return (
    ...
    >
      ...
      >
        <div className="fuwari-card-base overflow-visible! rounded-none! w-screen">
          <div className="flex items-center justify-between h-15 max-w-(--fuwari-page-width) mx-auto px-4">
